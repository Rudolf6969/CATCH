...
const styles = StyleSheet.create({
  ...
  filterBtnText: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 13, color: theme.colors.textPrimary },
  clearFilterBtn: { paddingHorizontal: 14, paddingVertical: 6 },
  clearFilterText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 13, color: '#E9A84C' },
  activeChip: { backgroundColor: 'rgba(64,145,108,0.2)', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4 },
  activeChipText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 12, color: theme.colors.primary },
  card: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 16,
  ...
  cardSpecies: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 15, color: theme.colors.textPrimary },
  cardWeight: { fontFamily: 'JetBrainsMono-Regular', fontSize: 13, color: theme.colors.primary },
  cardLocation: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 12, color: theme.colors.textMuted },
  cardDate: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 11, color: theme.colors.textMuted },
  cardArrow: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 20, color: theme.colors.textMuted },
  ...
  emptyText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 15, color: theme.colors.textMuted, textAlign: 'center', lineHeight: 22 },
  filterSheet: {
    position: 'absolute',
    bottom: 0,
    left: 0,
  ...
  filterLabel: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 12, color: theme.colors.textMuted, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  filterOptionText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 15, color: theme.colors.textSecondary },
  ...
  filterCloseBtnText: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 16, color: theme.colors.textPrimary },
});
