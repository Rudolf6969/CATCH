...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 13, color: 'rgba(255,255,255,0.6)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  searchInput: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontFamily: 'PlusJakartaSans-Medium', fontSize: 15, color: '#FFFFFF', marginBottom: 8 },
  ...
  selectedSpeciesText: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 15, color: '#40916C' },
  clearText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 13, color: 'rgba(255,255,255,0.5)' },
  ...
  speciesName: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 15, color: '#FFFFFF' },
  speciesLatin: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 12, color: 'rgba(255,255,255,0.4)', fontStyle: 'italic' },
  row: { flexDirection: 'row', gap: 12, marginBottom: 24 },
  inputHalf: { flex: 1 },
  inputLabel: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 6 },
  ...
  nextButtonText: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 16, color: '#0A1628' },
