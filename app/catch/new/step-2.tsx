...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Outfit-Bold', fontSize: 28, color: '#FFFFFF', marginBottom: 16 },
  errorText: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 14, color: '#FF6B6B', marginBottom: 12 },
  weatherSection: { marginBottom: 20 },
  sectionLabel: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 13, color: 'rgba(255,255,255,0.6)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  searchInput: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontFamily: 'PlusJakartaSans-Regular', fontSize: 15, color: '#FFFFFF', marginBottom: 8 },
  ...
  selectedSpeciesText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 15, color: '#40916C' },
  clearText: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 13, color: 'rgba(255,255,255,0.5)' },
  ...
  speciesName: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 15, color: '#FFFFFF' },
  speciesLatin: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 12, color: 'rgba(255,255,255,0.4)', fontStyle: 'italic' },
  row: { flexDirection: 'row', gap: 12, marginBottom: 24 },
  inputHalf: { flex: 1 },
  inputLabel: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 6 },
  ...
  backButtonText: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 14, color: 'rgba(255,255,255,0.5)' },
});
