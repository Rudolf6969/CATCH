...
const styles = StyleSheet.create({
  ...
  subtitle: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 16, color: 'rgba(255,255,255,0.6)', marginBottom: 24 },
  errorText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 14, color: '#FF6B6B', marginBottom: 16 },
  ...
  primaryButtonText: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 16, color: '#FFFFFF' },
  secondaryButton: { borderWidth: 1, borderColor: '#40916C', paddingVertical: 16, borderRadius: 12, alignItems: 'center', marginBottom: 32 },
  secondaryButtonText: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 16, color: '#40916C' },
  ...
  cancelButtonText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 14, color: 'rgba(255,255,255,0.5)' },
});
