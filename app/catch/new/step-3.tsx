...
const styles = StyleSheet.create({
  ...
  uploadText: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 14, color: 'rgba(255,255,255,0.7)' },
  inputLabel: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 6, marginTop: 16, textTransform: 'uppercase', letterSpacing: 0.5 },
  textInput: { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontFamily: 'PlusJakartaSans-Regular', fontSize: 15, color: '#FFFFFF' },
  ...
  visibilityLabel: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 15, color: '#FFFFFF' },
  ...
  submitButtonText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 16, color: '#0A1628' },
