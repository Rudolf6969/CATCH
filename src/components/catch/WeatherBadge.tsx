...
const styles = StyleSheet.create({
  ...
  label: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 11, color: theme.colors.textMuted, marginBottom: 2 },
  ...
  loadingText: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 14, color: theme.colors.textMuted },
});
