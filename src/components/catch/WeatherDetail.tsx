...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 13, color: theme.colors.textMuted, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 },
  time: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 13, color: theme.colors.textMuted, marginBottom: 12 },
  ...
  itemLabel: { fontFamily: 'PlusJakartaSans-Regular', fontSize: 11, color: theme.colors.textMuted },
});
