...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 13, color: theme.colors.textMuted, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 },
  time: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 13, color: theme.colors.textMuted, marginBottom: 12 },
  ...
  itemLabel: { fontFamily: 'PlusJakartaSans-Medium', fontSize: 11, color: theme.colors.textMuted },
});
